...
class Hamburger {
     ...
     */
    addTopping(topping) {
        !this.toppings.includes(topping) ? this._topping.push(topping) : null;
    }
    ...
    removeTopping(topping) {
        this.toppings.includes(topping) ? this._topping = this._topping.filter(item => item !== topping) : alert(`There is no ${topping}`);
    }
     ...
     */
    get toppings() {
        return this._topping.length > 0 ? this._topping : 'There is no toppings in your order';
    }
     ...
     */
    calculatePrice() {
        let topPrice = this._topping.map(item => Hamburger.TOPPINGS[item].price);
        let sum = Hamburger.SIZES[this.size].price + Hamburger.STUFFINGS[this.stuffing].price + topPrice.reduce((acc, item) => acc + item, 0);
        // console.log(sum);
        return sum;
    }
     ...
     */
    calculateCalories() {
        return this._topping.reduce((acc, item) => acc + Hamburger.TOPPINGS[item].calories, 0) + Hamburger.SIZES[this.size].calories + Hamburger.STUFFINGS[this.stuffing].calories;
        // console.log(Hamburger.TOPPINGS[this.topping].calories);
    }
}
