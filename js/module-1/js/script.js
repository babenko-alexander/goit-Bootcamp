...
let usersWish = prompt('Сколько путевок Вам нужно?');

if (usersWish === null) {
    alert('Вы не желаете отдыхать. Нам очень жаль, приходите еще!');
} else if (usersWish % 1 !== 0 || usersWish <= 0) {
    alert(error);
} else if (taba >= usersWish) {
    let order = confirm(`Есть ${usersWish} свобоных мест в Табу. Желаете приобрести?`);
    if (order === true) {
        alert('Приятного путешествия в Табу!');
    } else {
        alert('Нам очень жаль, приходите еще!');
    }
} else if (sharm >= usersWish) {
    let order = confirm(`Есть ${usersWish} свобоных мест в Шарм. Желаете приобрести?`);
    if (order === true) {
        alert('Приятного путешествия в Шарм!');
    } else {
        alert('Нам очень жаль, приходите еще!');
    }
} else if (hurgada >= usersWish) {
    let order = confirm(`Есть ${usersWish} свобоных мест в Хугарду. Желаете приобрести?`);
    if (order === true) {
        alert('Приятного путешествия в Хугарду!');
    } else {
        alert('Нам очень жаль, приходите еще!');
    }
} else {
